...
4. the measurement of the trigggers' use and effectiveness
...
information retrieval tasks and customization sks for the e-trigger as
neededThe development, testing, and implementation of the e-triggers
...
- The diagnostic safety team has identified specific motivations and
  expected outcomes of measurement activities that foster nonpunitive
...
of the e-trigger's accuracy is multistep process where the retrieved
...
groups will be made. Additionally, any learnings made about best
